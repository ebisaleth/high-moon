...
export default class IntroScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.bg_back = this.add.tileSprite(0, 0, 1228, 1500, 'stars-bg-back').setOrigin(0, 0)

    this.bg_front = this.add.tileSprite(0, 0, 1228, 2000, 'stars-bg-front').setOrigin(0, 0)

    this.bg_moon = this.add.image(0, -830, 'stars-bg-moon').setOrigin(0, 0)

    this.bg_text = this.add
      .image(0, 0, 'stars-bg-text')
      .setOrigin(0, 0)
      .setAlpha(0)

    this.pressKeyText = this.add
      .bitmapText(this.cameras.main.width / 2, 660 / 2 + 100, 'profont', 'press the SPACE key!')
      .setOrigin(0.5, 0.5)
      .setAlpha(0)
